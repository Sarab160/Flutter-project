// File generated by FlutterFire CLI — credentials moved to .env via AppConfig.
...
///
/// All API keys and app identifiers are loaded at runtime from the
/// bundled `.env` file via [AppConfig] — nothing is hardcoded here.
///
/// Example:
/// ```dart
